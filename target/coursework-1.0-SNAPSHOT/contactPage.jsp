...
<head>
    ...
    <style>
        <%@ include file="/styles/contact-page-styles.css" %>
    </style>
</head>
<body>
    ...
    <main class="main">
        <div class="container contact-block">
            <div class="row">
                <div class="col">
                    <div class="card contact-us-block border-siteBlue">
                        <div class="card-header text-white bg-color-siteBlue"><i class="fa fa-envelope"></i> Зв'язок з нами </div>
                        <div class="card-body">
                            <form>
                                <div class="form-group">
                                    <label for="name"><b class="mx-3">Ім'я</b></label>
                                    <input type="text" class="form-control" id="name" aria-describedby="emailHelp" placeholder="Введіть своє ім'я" required>
                                </div>
                                <div class="form-group">
                                    <label for="email"><b class="mx-3">Пошта</b></label>
                                    <input type="email" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Введіть свою пошту" required>
                                    <small id="emailHelp" class="form-text text-muted">Ми гарантуємо конфіденційність вашої email адреси.</small>
                                </div>
                                <div class="form-group">
                                    <label for="message"><b class="mx-3">Повідомлення</b></label>
                                    <textarea class="form-control" id="message" rows="6" required></textarea>
                                </div>
                                <div class="mx-auto">
                                    <button type="submit" class="btn btn-primary text-right bg-color-siteBlue m-1"> Відправити </button></div>
                            </form>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-4">
                    <div class="card mb-3 height-full address-block border-siteGreen">
                        <div class="card-header bg-color-siteGreen text-white"><i class="fa fa-home"></i> Адреса </div>
                        <div class="card-body bg-white p-5">
                            <b>
                                <p>вул. Стрийська 48</p>
                                <p>79026 Львів</p>
                                <p>Україна</p>
                                <p>Пошта: heatenergy@gmail.com</p>
                                <p>Тел. +380 11 22 333 44</p>
                                <p><a class="google-maps-link" target="_blank" href="https://www.google.com.ua/maps/place/%D1%83%D0%BB.+%D0%A1%D1%82%D1%80%D1%8B%D0%B9%D1%81%D0%BA%D0%B0%D1%8F,+48,+%D0%9B%D1%8C%D0%B2%D0%BE%D0%B2,+%D0%9B%D1%8C%D0%B2%D0%BE%D0%B2%D1%81%D0%BA%D0%B0%D1%8F+%D0%BE%D0%B1%D0%BB%D0%B0%D1%81%D1%82%D1%8C,+79000/@49.8224281,24.0199491,19z/data=!4m5!3m4!1s0x473ae78bd006a8f3:0x1aef129defa22b7e!8m2!3d49.8224739!4d24.0201965?hl=ru">Знайти в 'Google Maps' <img style="width: 15px" src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/aa/Google_Maps_icon_%282020%29.svg/1200px-Google_Maps_icon_%282020%29.svg.png" alt="GoogleMaps icon"></a></p>
                            </b>
                        </div>
                    </div>
                </div>
