        ...
        <div class="admin-page-content-block">
            ...
            <table class="table align-middle mb-0 bg-white">
                ...
                <tr>
                    ...
                    <th>Назва</th>
                    <th>Ціна тарифу, грн.</th>
                    <th>Редагування</th>
                </tr>
                </thead>

                <tbody>
                <c:forEach var="tariff" items="${requestScope.tariffsList}">
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <img
                                        src="https://cdn-icons-png.flaticon.com/512/5200/5200681.png"
                                        alt=""
                        ...
                        <td>
                            <form action="${pageContext.request.contextPath}/admin?update=tariff&form=price&id=${tariff.ID}" method="post">
                                <label>
                                    <input class="input_${tariff.ID}" name="price" type="text" value="${tariff.price}" disabled="disabled"/>
                                    <input class="submit_${tariff.ID}" style="margin: 1% 0 0 40%; display: none;" type="submit" value="✓"/>
                                </label>
                            </form>
                        </td>

                        <td>
                            <button onclick="edit_tariff(${tariff.ID})"
                                    type="button"
