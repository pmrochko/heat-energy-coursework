    ...
    <main class="main">
        <div class="start-content">
            <div class="start-text">
                <p>Інформаційна система користувачів теплопостачання</p>
                <c:choose>
                    <c:when test="${sessionScope.loginStatus == 'success'}">
                        <button class="anim-button" onclick="document.location='/user?action=goToProfile&openModalPay=success'">СПЛАТИТИ ЗА ТЕПЛО</button>
                    </c:when>
                    <c:otherwise>
                        <button class="anim-button" data-bs-toggle="modal" data-bs-target="#modal-login">СПЛАТИТИ ЗА ТЕПЛО</button>
                    </c:otherwise>
                </c:choose>
            </div>
            <div class="start-image"><img src="images/main-banner.png" alt="main banner image"></div>
        </div>

        <div class="eco-info">
            <img src="images/info_banner.png" alt="info banner image">
        </div>

        <div class="end-content">
            <c:choose>
                <c:when test="${sessionScope.loginStatus == 'success'}">
                    <button onclick="document.location='/user?action=goToProfile'" class="btn-top-left anim-button">Особистий кабінет</button>
                </c:when>
                <c:otherwise>
                    <button data-bs-toggle="modal" data-bs-target="#modal-login" class="btn-top-left anim-button">Особистий кабінет</button>
                </c:otherwise>
            </c:choose>
            <button onclick="document.location='communityInfo3.jsp'" class="btn-center anim-button">Як оформити субсидію</button>
            <button onclick="document.location='communityInfo4.jsp'" class="btn-bottom-right anim-button">Новини</button>
        </div>
    </main>
