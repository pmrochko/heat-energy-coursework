            ...
            <div class="info-4">
                <div class="news-item">
                    <a href="">
                        ...
                        <div class="news-info">Увага! Зміна реквізитів!</div>
                    </a>
                </div>
                <div class="news-item">
                    <a href="">
                        <div class="news-image"></div>
                        <div class="news-info">Громадські слухання щодо тарифів на тепло</div>
                    </a>
                </div>
                <div class="news-item">
                    <a href="">
                        <div class="news-image"></div>
                        <div class="news-info">Загальнобудинкові потреби на опалення – що це?</div>
                    </a>
                </div>
                <div class="news-item">
                    <a href="">
                        <div class="news-image"></div>
                        <div class="news-info">Плата за абонентське обслуговування</div>
                    </a>
                </div>
                <div class="news-item">
                    <a href="">
                        <div class="news-image"></div>
                        <div class="news-info">Шановні споживачі теплової енергії!</div>
                    </a>
                </div>
                <div class="news-item">
                    <a href="">
                        <div class="news-image"></div>
                        <div class="news-info">Інформаційне повідомлення про зміни до розрахунку...</div>
                    </a>
                </div>
            </div>
