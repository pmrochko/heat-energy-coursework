...
<head>
    ...
    <style><%@ include file="styles/index-styles.css" %></style>
    <style><%@ include file="styles/tariffs-page-styles.css" %></style>
</head>
<body>
    ...
    <main class="main">
        <div class="tariffs-content-block">
            <div class="tariff-block">
                <h3 class="table-title">Тарифи на централізоване опалення</h3>
                <table>
                    <tr class="table-header-row">
                        <td>Без приладів обліку теплової енергії</td>
                        <td>За наявності приладів обліку теплової енергії</td>
                    </tr>
                    <tr class="table-body-row">
                        <td>1 м2/міс = ${requestScope.priceTariff1_b} грн. без ПДВ</td>
                        <td>1 Гкал = ${requestScope.priceTariff2_b} грн. без ПДВ</td>
                    </tr>
                    <tr class="table-body-row">
                        <td>1 м2/міс = ${requestScope.priceTariff1} грн. з ПДВ</td>
                        <td>1 Гкал = ${requestScope.priceTariff2} грн. з ПДВ</td>
                    </tr>
                </table>
            </div>

            <div class="tariff-block">
                <h3 class="table-title">Тарифи на послугу з постачання теплової енергії</h3>
                <table>
                    <tr class="table-header-row">
                        <td>За наявності приладів обліку теплової енергії</td>
                    </tr>
                    <tr class="table-body-row">
                        <td>1 Гкал = ${requestScope.priceTariff3} грн. з ПДВ</td>
                    </tr>
                </table>
            </div>

            <div class="tariff-block">
                <h3 class="table-title">Тарифи на централізоване постачання гарячої води</h3>
                <table>
                    <tr class="table-header-row">
                        <td>За умови підключення рушникосушарки</td>
                        <td>За умови відсутності рушникосушарки</td>
                    </tr>
                    <tr class="table-body-row">
                        <td>1 м3 = ${requestScope.priceTariff4_b} грн. без ПДВ</td>
                        <td>1 м3 = ${requestScope.priceTariff5_b} грн. без ПДВ</td>
                    </tr>
                    <tr class="table-body-row">
                        <td>1 м3 = ${requestScope.priceTariff4} грн. з ПДВ</td>
                        <td>1 м3 = ${requestScope.priceTariff5} грн. з ПДВ</td>
                    </tr>
                </table>
            </div>

            <div class="tariff-block">
                <h3 class="table-title">Тарифи на послугу з постачання гарячої води</h3>
                <table>
                    <tr class="table-header-row">
                        <td>Споживачам, які отримують послугу без використання індивідуальних теплових пунктів, для потреб населення</td>
                    </tr>
                    <tr class="table-body-row">
                        <td>1 м3 = ${requestScope.priceTariff6} грн. з ПДВ</td>
                    </tr>
                </table>
            </div>

            <div class="tariff-footer-info">
                <hr/>
                <img src="images/folder-doc-icon.png" alt="pay">
                <strong style="color: #007fd2">Тарифи на всі вказані послуги затверджені Постановою від 01.01.2022 №60 Національної комісії</strong>
                <br/>
                <img src="images/google-pay-logo.png" alt="pay">
                <strong>Сплачувати по тарифам за централізоване опалення потрібно тільки в опалювальний період</strong>
                <hr/>
            </div>
        </div>
    </main>
