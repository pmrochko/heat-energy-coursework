...
<body>
    ...
    <main class="main">
        <div class="community-content-block">
            <div class="item-block anim-button">
                <button onclick="document.location='communityInfo1.jsp'" class="background-cards"></button>
                <strong>Реквізити</strong>
            </div>
            <div class="item-block anim-button">
                <button onclick="document.location='communityInfo2.jsp'" class="background-documentation"></button>
                <strong>Нормативно-правова база</strong>
            </div>
            <div class="item-block anim-button">
                <button onclick="document.location='communityInfo3.jsp'" class="background-subsidy"></button>
                <strong>Оформлення субсидії</strong>
            </div>
            <div class="item-block anim-button">
                <button onclick="document.location='communityInfo4.jsp'" class="background-news"></button>
