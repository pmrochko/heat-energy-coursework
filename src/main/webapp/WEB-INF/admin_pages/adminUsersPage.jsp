...
<head>
    ...
    <style><%@ include file="../../styles/admin-pages-styles.css" %></style>
</head>
<body>
    ...
    <main class="main">
        <div class="admin-page-content-block">
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                />
                                <div class="ms-3">
                                    <span style="font-weight: bold">${user.surname} ${user.name}</span>
                                </div>
                            </div>
                        </td>
                        ...
                        <td>
                            <c:choose>
                                <c:when test="${user.banStatus == 'banned'}">
                                    <span style="color: #e30000">BANNED</span>
                                </c:when>
                                <c:otherwise>
                        ...
                        <td>
                            <form action="${pageContext.request.contextPath}/admin?update=user&form=email&id=${user.ID}" method="post">
                                <label>
                                    <input class="input_${user.ID}" name="email" type="email" value="${user.email}" disabled="disabled"/>
                                    <input class="submit_${user.ID}" style="margin: 1% 0 0 40%; display: none;" type="submit" value="✓"/>
                                </label>
                            </form>
                        </td>

                        <td>
                            <form action="${pageContext.request.contextPath}/admin?update=user&form=address&id=${user.ID}" method="post">
                                <label>
                                    <input class="input_${user.ID}" name="address" type="text" value="${user.address}" disabled="disabled"/>
                                    <input class="submit_${user.ID}" style="margin: 1% 0 0 40%; display: none;" type="submit" value="✓"/>
                                </label>
                            </form>
                        </td>
                        ...
                        <td>
                            <form action="${pageContext.request.contextPath}/admin?update=user&form=tel&id=${user.ID}" method="post">
                                <label>
                                    <input class="input_${user.ID}" name="tel" type="text" value="${user.phoneNumber}" disabled="disabled"/>
                                    <input class="submit_${user.ID}" style="margin: 1% 0 0 40%; display: none;" type="submit" value="✓"/>
                                </label>
                            </form>
                        </td>
                        ...
                        <td>
                            <button onclick="edit_tariff(${user.ID})"
                                    type="button"
                            ...
                            <c:if test="${user.ID != sessionScope.currentUser.ID}">
                                <c:choose>
                                    <c:when test="${user.banStatus == 'banned'}">
                                        <br>
                                        <button onclick="document.location='/admin?action=unblock&userID=${user.ID}'"
                                                style="color: #31e300"
                                                type="button"
                                                class="btn btn-link btn-rounded btn-sm fw-bold"
                                                data-mdb-ripple-color="dark"
                                    ...
                                    <c:otherwise>
                                        <br>
                                        <button onclick="document.location='/admin?action=ban&userID=${user.ID}'"
                                                style="color: #e30000"
                                                type="button"
                                                class="btn btn-link btn-rounded btn-sm fw-bold"
                                                data-mdb-ripple-color="dark"
    ...
    ></script>
    <script src="../../scripts/admin-pages-script.js"></script>
</body>
</html>