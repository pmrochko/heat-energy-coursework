...
<body>
    ...
    <main class="main">
        <div class="community-content-block">
            ...
            <div class="info-1">
                <h2>Реквізити для оплати послуг</h2>
                <hr>
                <p>Платежі за теплову енергію Ви можете здійснити у зручних для Вас відділеннях та в
                    <c:choose>
                        <c:when test="${not empty sessionScope.currentUser}">
                            <a class="info-link" href="profile.jsp">особистому кабінеті</a>
                        </c:when>
                        <c:otherwise>
                            <a class="info-link" href="" data-bs-toggle="modal" data-bs-target="#modal-login">особистому кабінеті</a>
                        </c:otherwise>
                    </c:choose>
                    .</p>
                <p>Для достовірного та повного відображення Вашого платежу будь ласка, надайте касиру наступну інформацію:<br><strong>Отримувач платежу:</strong> КП «Теплопостачання міста»,<br><strong>Код ЄДРПОУ:</strong> 34674102<br><strong>Рахунок:</strong> №<strong>UA753288450000026005300416451</strong>, в АТ «ОЩАДБАНК»<br><strong>МФО: </strong>328845</p>
                <p>З метою правильного зарахування сум платежів, будь ласка обов’язково вкажіть:<br>Адресу, П.І.Б. та номер особового рахунку. Для уточнення Вашого особового рахунку звертайтесь до колцентру КП «ТМО», тел. (048) 705-61-00</p>
                <p>У разі дотримання вказаних рекомендацій сплачені грошові суми будуть зараховані належним чином, а інформація про проведені платежі повністю відображена на Вашому особистому рахунку.</p>
                <p>У випадку відмови прийняття платежу у відділеннях банків звертайтесь до колцентру та абонентських відділів КП «ТМО».</p>
                <p><strong>UA403288450000026037301416451</strong> — для зарахування коштів, які надходять за спожиту теплову енергію від категорії споживачів «населення» і з відповідних поточних рахунків із спеціальним режимом використання структурних підрозділів теплопостачальних організацій;<br><br><strong>UA353288450000026036302416451</strong> — для зарахування коштів, які надходять за спожиту теплову енергію від категорії споживачів «бюджетні установи» і з відповідних поточних рахунків із спеціальним режимом використання структурних підрозділів теплопостачальних організацій;<br><br><strong>UA303288450000026035303416451</strong> — для зарахування коштів, які надходять за спожиту теплову енергію від категорії споживачів «інші споживачі» і з відповідних поточних рахунків із спеціальним режимом використання структурних підрозділів теплопостачальних організацій;<br><br><strong>UA253288450000026034304416451</strong> — для зарахування коштів, які надходять за спожиту теплову енергію від категорії споживачів «релігійні установи»;<br>• у филії ОУ «ОЩАДБАНК»<br>• МФО 328845<br>• код ОКПО 34674102</p>
            </div>
